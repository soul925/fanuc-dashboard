    ...
    _on_HEL_message(data, callback) {
        ...
        if (msgType === "HEL") {
            try {
                ...
                const decoded = (0, tools_1.decodeMessage)(stream, HelloMessage_1.HelloMessage);
                if (!(decoded instanceof HelloMessage_1.HelloMessage)) {
                ...
                if (helloMessage.protocolVersion === 0xdeadbeef || helloMessage.protocolVersion < this.protocolVersion) {
                    ...
                    this._abortWithError(node_opcua_status_code_1.StatusCodes.BadProtocolVersionUnsupported, `Protocol Version Error${this.protocolVersion}`, callback);
                    return;
                }
                ...
                if (helloMessage.receiveBufferSize < minimumBufferSize || helloMessage.sendBufferSize < minimumBufferSize) {
                    this._abortWithError(node_opcua_status_code_1.StatusCodes.BadConnectionRejected, `Buffer size too small (should be at least ${minimumBufferSize}`, callback);
                    return;
                }
                ...
                this._abortWithError(node_opcua_status_code_1.StatusCodes.BadConnectionRejected, err instanceof Error ? err.message : "", callback);
                return;
            }
        }
        else {
