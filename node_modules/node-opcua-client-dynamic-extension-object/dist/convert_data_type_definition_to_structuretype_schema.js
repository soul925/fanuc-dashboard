        ...
        if (isAbstract) {
            ...
            if (_isExtensionObject) {
                ...
                const isBaseDataType = dataTypeNodeId.namespace === 0
                    && dataTypeNodeId.value === node_opcua_constants_1.DataTypeIds.BaseDataType;
                const v3 = {
                    category: node_opcua_factory_1.FieldCategory.basic,
...
async function convertDataTypeDefinitionToStructureTypeSchema(session, dataTypeNodeId, name, definition, dataTypeDescription, dataTypeManager, isAbstract, cache) {
    return await nonReentrant(cache, "convertDataTypeDefinitionToStructureTypeSchema", dataTypeNodeId, async () => {
        if (definition instanceof node_opcua_types_1.StructureDefinition) {
            ...
            if (isUnion && (0, node_opcua_nodeid_1.sameNodeId)(definition.baseDataType, (0, node_opcua_nodeid_1.coerceNodeId)(node_opcua_constants_1.DataTypeIds.Structure))) {
                definition.baseDataType = (0, node_opcua_nodeid_1.resolveNodeId)(node_opcua_constants_1.DataTypeIds.Union); // aka DataTypeIds.Union
            }
