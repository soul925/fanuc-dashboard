...
exports.addTwoStateDiscreteVariables = addTwoStateDiscreteVariables;
exports.addMultiStateDiscreteVariable = addMultiStateDiscreteVariable;
exports.addMultiStateValueDiscreteVariables = addMultiStateValueDiscreteVariables;
...
function addTwoStateDiscreteVariables(namespace, parentFolder) {
...
function addMultiStateDiscreteVariable(namespace, parentFolder) {
    const DADiscreteTypeFolder = getDADiscreteTypeFolder(namespace, parentFolder);
    for (let i = 1; i <= 5; i++) {
...
function addMultiStateValueDiscreteVariables(namespaceDemo, parentFolder) {
    ...
    function _add_multi_state_variable(folder, dataType, _value, enumValues) {
...
//# sourceMappingURL=discrete_variables.js.map