...
class ServerSession extends events_1.EventEmitter {
    ...
    constructor(parent, userManager, sessionTimeout) {
        ...
        const authenticationTokenBuf = (0, node_opcua_utils_1.randomBytes)(16);
    ...
    onClientSeen() {
        ...
        if (this._sessionDiagnostics) {
            ...
            (0, node_opcua_assert_1.assert)(Object.hasOwn(this._sessionDiagnostics, "currentMonitoredItemsCount"));
            (0, node_opcua_assert_1.assert)(Object.hasOwn(this._sessionDiagnostics, "currentSubscriptionsCount"));
            (0, node_opcua_assert_1.assert)(Object.hasOwn(this._sessionDiagnostics, "currentPublishRequestsInQueue"));
    ...
    incrementRequestTotalCounter(counterName) {
        if (this._sessionDiagnostics) {
            const propName = (0, node_opcua_utils_1.lowerFirstLetter)(counterName + "Count");
            // c8 ignore next
    ...
    createSubscription(parameters) {
        ...
        (0, node_opcua_assert_1.assert)(!Object.hasOwn(parameters, "id"));
    ...
    _attach_channel(channel) {
        ...
        (0, node_opcua_assert_1.assert)(!Object.hasOwn(channel.sessionTokens, key), "channel has already a session");
    ...
    _detach_channel() {
        ...
        const key = this.authenticationToken.toString();
        (0, node_opcua_assert_1.assert)(Object.hasOwn(channel.sessionTokens, key));
