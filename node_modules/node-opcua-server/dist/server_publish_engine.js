 ...
 */
class ServerSidePublishEngine extends node_events_1.EventEmitter {
    ...
    add_subscription(subscription) {
        ...
        (0, node_opcua_assert_1.assert)(Number.isFinite(subscription.id));
    ...
    get currentMonitoredItemCount() {
        ...
        (0, node_opcua_assert_1.assert)(Number.isFinite(result));
        return result;
    }
    ...
    findLateSubscriptions() {
        ...
        return subscriptions.filter((subscription) => {
            return (subscription.state === server_subscription_1.SubscriptionState.LATE || !subscription.messageSent) && subscription.publishingEnabled;
        });
    }
    ...
    findLateSubscriptionsSortedByAge() {
        ...
        late_subscriptions = (0, lodash_sortby_1.default)(late_subscriptions, "timeToExpiration");
        ...
        function findLateSubscriptionSortedByPriority() {
            ...
            if (doDebug) {
                debugLog(late_subscriptions
                    ...
                    " " +
                    server_subscription_1.SubscriptionState[s.state] +
                    " " +
                    s.messageSent +
                    "]")
                    .join(" \n"));
    ...
    _send_response(_subscription, response) {
        (0, node_opcua_assert_1.assert)(this.pendingPublishRequestCount > 0);
    ...
    _cancelTimeoutRequests() {
        ...
        const parts = (0, lodash_partition_1.default)(this._publish_request_queue, timeout_filter);
