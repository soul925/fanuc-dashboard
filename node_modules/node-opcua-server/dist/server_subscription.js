...
class Subscription extends node_events_1.EventEmitter {
    ...
    get maxWhereClauseParameters() {
        return this.serverCapabilities.maxWhereClauseParameters;
    }
    get maxSelectClauseParameters() {
    ...
    toJSON() {
        return {
            id: this.id,
            sessionId: this.getSessionId() ? this.getSessionId().toString() : node_opcua_nodeid_1.NodeId.nullNodeId.toString(),
