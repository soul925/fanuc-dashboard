...
class OPCUAServer extends base_server_1.OPCUABaseServer {
    ...
    makeServerNonce() {
        return (0, node_opcua_utils_1.randomBytes)(32);
    }
    // session services
            ...
            this.isUserAuthorized(channel, session, request.userIdentityToken, (err1, authorized) => {
                ...
                if (!authorized) {
                    ...
                    const activationStatus = session.passwordChangeRequired
                        ? node_opcua_status_code_1.StatusCodes.GoodPasswordChangeRequired
   ...
   */
    ...
    createEndpoint(port1, serverOptions) {
        ...
        endPoint.setCertificateProvider(new node_opcua_common_1.DiskCertificateKeyPairProvider(this.certificateFile, this.privateKeyFile));
        return endPoint;
    }
