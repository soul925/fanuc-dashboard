...
const _doDebug = (0, node_opcua_debug_1.checkDebugFlag)("REGISTER_LDS");
...
async function sendRegisterServerRequest(server, client, isOnline) {
    ...
    await new Promise((resolve, reject) => {
        client.performMessageTransaction(request, (err, _response) => {
            if (!err) {
            ...
            client.performMessageTransaction(request1, (err1, _response1) => {
                if (!err1) {
 ...
 */
class RegisterServerManager extends node_events_1.EventEmitter {
    ...
    selectedEndpoint;
    _serverEndpoints = [];
    _backgroundProcessPromise = null;
    getState() {
        return this.state;
    }
    constructor(options) {
    ...
    #_isTerminating() {
        return (this.getState() === i_register_server_manager_1.RegisterServerManagerStatus.UNREGISTERING ||
            this.getState() === i_register_server_manager_1.RegisterServerManagerStatus.DISPOSING);
    }
    /**
