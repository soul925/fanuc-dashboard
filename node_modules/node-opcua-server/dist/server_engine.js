...
function requestServerStateChange(inputArguments, context, callback) {
    ...
    (0, node_opcua_assert_1.assert)(typeof callback === "function");
    (0, node_opcua_assert_1.assert)(Object.hasOwn(context, "session"), " expecting a session id in the context object");
...
class ServerEngine extends node_events_1.EventEmitter {
    ...
    constructor(options) {
        ...
        (0, node_opcua_assert_1.assert)(Object.hasOwn(this.serverDiagnosticsSummary, "currentSessionCount"));
        ...
        (0, node_opcua_assert_1.assert)(Object.hasOwn(this.serverDiagnosticsSummary, "currentSubscriptionCount"));
...
*/
            ...
            const prepareServerDiagnostics = () => {
                ...
                serverDiagnosticsNode.enabledFlag.accessLevel =
                    (0, node_opcua_data_model_1.makeAccessLevelFlag)("CurrentRead | CurrentWrite");
                serverDiagnosticsNode.enabledFlag.userAccessLevel =
                    (0, node_opcua_data_model_1.makeAccessLevelFlag)("CurrentRead | CurrentWrite");
                serverDiagnosticsNode.enabledFlag.setRolePermissions([
                    { roleId: node_opcua_address_space_1.WellKnownRoles.Anonymous, permissions: node_opcua_types_1.PermissionType.Read | node_opcua_types_1.PermissionType.Browse },
                    { roleId: node_opcua_address_space_1.WellKnownRoles.AuthenticatedUser, permissions: node_opcua_types_1.PermissionType.Read | node_opcua_types_1.PermissionType.Browse },
                    { roleId: node_opcua_address_space_1.WellKnownRoles.Observer, permissions: node_opcua_types_1.PermissionType.Read | node_opcua_types_1.PermissionType.Browse },
                    { roleId: node_opcua_address_space_1.WellKnownRoles.Operator, permissions: node_opcua_types_1.PermissionType.Read | node_opcua_types_1.PermissionType.Browse },
                    { roleId: node_opcua_address_space_1.WellKnownRoles.Engineer, permissions: node_opcua_types_1.PermissionType.Read | node_opcua_types_1.PermissionType.Browse },
                    { roleId: node_opcua_address_space_1.WellKnownRoles.Supervisor, permissions: node_opcua_types_1.PermissionType.Read | node_opcua_types_1.PermissionType.Browse },
                    { roleId: node_opcua_address_space_1.WellKnownRoles.ConfigureAdmin,
                        permissions: node_opcua_types_1.PermissionType.Read | node_opcua_types_1.PermissionType.Browse | node_opcua_types_1.PermissionType.Write },
    ...
    async transferSubscription(session, subscriptionId, sendInitialValues) {
        ...
        const sourceIdentity = subscription.$session
            ? (0, sessions_compatible_for_transfer_1.getTransferSessionIdentity)(subscription.$session)
            : subscription.$transferSessionIdentity;
        if (!(0, sessions_compatible_for_transfer_1.sessionsCompatibleForTransfer)(sourceIdentity, session, {
    ...
    _createSubscriptionOnSession(session, request) {
        (0, node_opcua_assert_1.assert)(Object.hasOwn(request, "requestedPublishingInterval")); // Duration
        (0, node_opcua_assert_1.assert)(Object.hasOwn(request, "requestedLifetimeCount")); // Counter
        (0, node_opcua_assert_1.assert)(Object.hasOwn(request, "requestedMaxKeepAliveCount")); // Counter
        (0, node_opcua_assert_1.assert)(Object.hasOwn(request, "maxNotificationsPerPublish")); // Counter
        (0, node_opcua_assert_1.assert)(Object.hasOwn(request, "publishingEnabled")); // Boolean
        (0, node_opcua_assert_1.assert)(Object.hasOwn(request, "priority")); // Byte
