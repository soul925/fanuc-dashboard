...
let g_logLevel = process.env.NODEOPCUA_LOG_LEVEL
    ? parseInt(process.env.NODEOPCUA_LOG_LEVEL, 10)
    : LogLevel.Warning;
...
function dump(ctx, mode, args1) {
    ...
    const output = (0, node_util_1.format)(...a2);
...
class MessageLogger extends node_events_1.EventEmitter {
...
function make_errorLog(_context) {
    return errorLogFunc;
}
...
function make_warningLog(_context) {
...
function make_traceLog(_context) {
    return traceLogFunc;
}
