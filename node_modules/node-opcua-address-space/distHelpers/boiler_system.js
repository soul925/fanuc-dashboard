...
const __1 = require("..");
function myGetExecutableFlag(method, toState, _methodName) {
...
function implementProgramStateMachine(programStateMachine) {
    function installMethod(methodName, toState) {
        ...
        if (!method) {
            ...
            if (!methodToClone) {
                methodToClone = programStateMachine.typeDefinitionObj?.subtypeOfObj?.getMethodByName(methodName) || null;
            }
            methodToClone?.clone({
        ...
        method?.bindMethod(function (_inputArguments, _context, callback) {
        ...
        const _lc_name = (0, node_opcua_utils_1.lowerFirstLetter)(methodName);
    }
...
function createBoilerType(namespace) {
    ...
    // EventTypes
    // --------------------------------------------------------
    const _boilerHaltedEventType = namespace.addEventType({
        browseName: "BoilerHaltedEventType",
        subtypeOf: "TransitionEventType"
    });
    _boilerHaltedEventType;
    // --------------------------------------------------------
    ...
    const _input1 = namespace.addVariable({
        browseName: "Input1",
        dataType: "Double",
        description: "a reference that indicates an electrical signal between two variables",
    ...
    _input1;
    const _input2 = namespace.addVariable({
        browseName: "Input2",
        dataType: "Double",
        modellingRule: "Mandatory",
        propertyOf: customControllerType
    ...
    _input2;
    const _input3 = namespace.addVariable({
        browseName: "Input3",
        dataType: "Double",
        modellingRule: "Mandatory",
        propertyOf: customControllerType
    ...
    _input3;
    const _controlOut = namespace.addVariable({
    ...
    _controlOut;
    const _description = namespace.addVariable({
    ...
    const _valve1 = valveType.instantiate({
        browseName: "Valve",
        componentOf: boilerInputPipeType,
        modellingRule: "Mandatory"
    });
    ...
    const _customController = customControllerType.instantiate({
    ...
    const _flowController = flowControllerType.instantiate({
    ...
    const _levelController = levelControllerType.instantiate({
    ...
    const _simulation = boilerStateMachineType.instantiate({
