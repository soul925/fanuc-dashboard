 ...
 */
import type { BaseNodeEvents, InstantiateObjectOptions, ISessionContext, UAObject, UAObjectType } from "node-opcua-address-space-base";
import { AttributeIds, NodeClass } from "node-opcua-data-model";
import { DataValue } from "node-opcua-data-value";
import type { NodeId } from "node-opcua-nodeid";
import { BaseNodeImpl } from "./base_node_impl";
export declare class UAObjectTypeImpl extends BaseNodeImpl<BaseNodeEvents> implements UAObjectType {
    ...
    isSubtypeOf: import("./tool_isSubtypeOf").IsSubtypeOfFunc<UAObjectType>;
    /** @deprecated - use  isSubtypeOf instead */
    isSupertypeOf: import("./tool_isSubtypeOf").IsSubtypeOfFunc<UAObjectType>;
