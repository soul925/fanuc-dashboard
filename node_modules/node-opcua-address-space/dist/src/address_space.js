...
class AddressSpace {
    ...
    generateEventId() {
        ...
        if (!self._eventIdCounter) {
            self._eventIdCounter = (0, node_opcua_utils_1.randomBytes)(20);
    ...
    installAlarmsAndConditionsService() {
        alarms_and_conditions_1.UAConditionImplBase.install_condition_refresh_handle(this);
        alarms_and_conditions_1.UAAcknowledgeableConditionImplBase.install_method_handle_on_type(this);
    }
    // -- internal stuff -----------------------------------------------------------------------------------------------
    _coerceNode(node) {
