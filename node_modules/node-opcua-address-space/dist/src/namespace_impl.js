...
class NamespaceImpl {
    ...
    addAnalogDataItem(options) {
        ...
        if (options.typeDefinition) {
            const t = options.typeDefinition instanceof base_node_impl_1.BaseNodeImpl
                ? options.typeDefinition
                : addressSpace.findVariableType(options.typeDefinition);
            if (!t) {
        ...
        const isStrictSubtype = !(0, node_opcua_nodeid_1.sameNodeId)(requestedTypeDefinition.nodeId, analogItemType.nodeId);
        let variable;
        if (isStrictSubtype) {
            ...
            variable = requestedTypeDefinition.instantiate({
                ...
                dataType: addressSpace._coerce_DataType(dataType),
            ...
            variable = this.addVariable(clone_options);
        }
        (0, add_dataItem_stuff_1.add_dataItem_stuff)(variable, options);
        ...
        const euRangeExisting = variable.getPropertyByName("EURange");
        const euRange = euRangeExisting ||
            this.addVariable({
        ...
        if (euRangeExisting) {
            euRange.setValueFromSource(new node_opcua_variant_1.Variant({ dataType: node_opcua_variant_1.DataType.ExtensionObject, value: new node_opcua_types_1.Range(options.engineeringUnitsRange) }), node_opcua_status_code_1.StatusCodes.Good);
        }
        ...
        if (Object.hasOwn(options, "instrumentRange")) {
            const instrumentRangeExisting = variable.getPropertyByName("InstrumentRange");
            const instrumentRange = instrumentRangeExisting ||
                this.addVariable({
            ...
            if (instrumentRangeExisting) {
                instrumentRange.setValueFromSource(new node_opcua_variant_1.Variant({ dataType: node_opcua_variant_1.DataType.ExtensionObject, value: new node_opcua_types_1.Range(options.instrumentRange) }), node_opcua_status_code_1.StatusCodes.Good);
            }
        ...
        if (Object.hasOwn(options, "engineeringUnits")) {
            ...
            const euExisting = variable.getPropertyByName("EngineeringUnits");
            const eu = euExisting ||
                this.addVariable({
            ...
            if (euExisting) {
                eu.setValueFromSource(new node_opcua_variant_1.Variant({ dataType: node_opcua_variant_1.DataType.ExtensionObject, value: engineeringUnits }), node_opcua_status_code_1.StatusCodes.Good);
            }
    ...
    instantiateCondition(conditionTypeId, options, data) {
        return alarms_and_conditions_1.UAConditionImplBase.instantiate(this, conditionTypeId, options, data);
    }
    instantiateAcknowledgeableCondition(conditionTypeId, options, data) {
        return alarms_and_conditions_1.UAAcknowledgeableConditionImplBase.instantiate(this, conditionTypeId, options, data);
    }
    instantiateAlarmCondition(alarmConditionTypeId, options, data) {
        return alarms_and_conditions_1.UAAlarmConditionImplBase.instantiate(this, alarmConditionTypeId, options, data);
    }
    instantiateLimitAlarm(limitAlarmTypeId, options, data) {
        return ua_limit_alarm_impl_1.UALimitAlarmImplBase.instantiate(this, limitAlarmTypeId, options, data);
    }
    instantiateExclusiveLimitAlarm(exclusiveLimitAlarmTypeId, options, data) {
        return ua_exclusive_limit_alarm_impl_1.UAExclusiveLimitAlarmImplBase.instantiate(this, exclusiveLimitAlarmTypeId, options, data);
    }
    instantiateExclusiveDeviationAlarm(options, data) {
        return ua_exclusive_deviation_alarm_impl_1.UAExclusiveDeviationAlarmImplBase.instantiate(this, "ExclusiveDeviationAlarmType", options, data);
    }
    instantiateNonExclusiveLimitAlarm(nonExclusiveLimitAlarmTypeId, options, data) {
        return ua_non_exclusive_limit_alarm_impl_1.UANonExclusiveLimitAlarmImplBase.instantiate(this, nonExclusiveLimitAlarmTypeId, options, data);
    }
    instantiateNonExclusiveDeviationAlarm(options, data) {
        return ua_non_exclusive_deviation_alarm_impl_1.UANonExclusiveDeviationAlarmImplBase.instantiate(this, "NonExclusiveDeviationAlarmType", options, data);
    }
    instantiateDiscreteAlarm(discreteAlarmType, options, data) {
        return alarms_and_conditions_1.UADiscreteAlarmImplBase.instantiate(this, discreteAlarmType, options, data);
    }
    instantiateOffNormalAlarm(options, data) {
        return ua_off_normal_alarm_impl_1.UAOffNormalAlarmImplBase.instantiate(this, "OffNormalAlarmType", options, data);
    }
