...
function is_valid_reference(ref) {
    const hasRequestedProperties = Object.hasOwn(ref, "referenceType") && Object.hasOwn(ref, "nodeId") && !(0, node_opcua_utils_1.isNullOrUndefined)(ref.isForward);
...
function errorLog(_arg0, _reference) {
