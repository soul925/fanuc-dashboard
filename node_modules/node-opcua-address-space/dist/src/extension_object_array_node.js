...
function createExtObjArrayNode(parentFolder, options) {
    ...
    const inner_options = {
        ...
        value: { dataType: node_opcua_variant_1.DataType.ExtensionObject, value: [], arrayType: node_opcua_variant_1.VariantArrayType.Array },
        valueRank: 1
    };
...
function _getElementBrowseName(extObj, _index) {
    ...
    (0, node_opcua_assert_1.assert)(Object.hasOwn(extObj, indexPropertyName1));
...
function bindExtObjArrayNode(uaArrayVariableNode, variableTypeNodeId, indexPropertyName) {
    ...
    uaArrayVariableNode.$dataValue.value.arrayType = node_opcua_variant_1.VariantArrayType.Array;
    const bindOptions = {
...
function addElement(options, uaArrayVariableNode) {
    ...
    if (options instanceof ua_variable_impl_1.UAVariableImpl) {
        ...
        elVar = uaArrayVariableNode.$$variableType.instantiate({
            ...
            value: { dataType: node_opcua_variant_1.DataType.ExtensionObject, value: extensionObject }
        });
...
function removeElement(uaArrayVariableNode, element) {
    ...
    if (typeof element === "number") {
        ...
        elementIndex = _array.findIndex((obj, _i) => {
