 ...
 */
import type { INamespace, UAVariableT } from "node-opcua-address-space-base";
 ...
 */
export declare class UAOffNormalAlarmImplBase extends UADiscreteAlarmImplBase {
    /**
     * When the value of inputNode doesn't match the normalState node value, then the alarm is raised.
     *
     */
    static instantiate<_T, _DT extends DataType>(namespace: INamespace, limitAlarmTypeId: string | NodeId, options: InstantiateOffNormalAlarmOptions, data?: Record<string, VariantOptions>): UAOffNormalAlarmImpl;
    private get $4();
    getNormalStateNode(): UAVariableT<NodeId, DataType.NodeId> | null;
    /**
     */
    ...
    /**
     */
    setNormalStateValue(_value: NodeIdLike): void;
...
export declare const UAOffNormalAlarmImpl: new () => UAOffNormalAlarmImpl;
