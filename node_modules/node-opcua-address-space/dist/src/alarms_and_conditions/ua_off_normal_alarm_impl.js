...
exports.UAOffNormalAlarmImpl = exports.UAOffNormalAlarmImplBase = void 0;
 ...
 */
class UAOffNormalAlarmImplBase extends ua_discrete_alarm_impl_1.UADiscreteAlarmImplBase {
    /**
    ...
    static instantiate(namespace, limitAlarmTypeId, options, data) {
        ...
        (0, node_opcua_assert_1.assert)(Object.hasOwn(options, "inputNode"), "must provide inputNode"); // must provide a inputNode
        (0, node_opcua_assert_1.assert)(Object.hasOwn(options, "normalState"), "must provide a normalState Node"); // must provide a inputNode
        options.optionals = options.optionals || [];
        (0, node_opcua_assert_1.assert)(Object.hasOwn(options, "inputNode"), "must provide inputNode"); // must provide a inputNode
        const alarmNode = ua_discrete_alarm_impl_1.UADiscreteAlarmImplBase.instantiate(namespace, limitAlarmTypeId, options, data);
        Object.setPrototypeOf(alarmNode, exports.UAOffNormalAlarmImpl.prototype);
        /**
...
exports.UAOffNormalAlarmImplBase = UAOffNormalAlarmImplBase;
exports.UAOffNormalAlarmImpl = UAOffNormalAlarmImplBase;
