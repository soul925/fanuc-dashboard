import type { BaseNode, CloneExtraInfo, CloneFilter, IAddressSpace, ISessionContext, UAMethod, UAObject, UAObjectType, UAReference, UAReferenceType, UAVariable, UAVariableT, UAVariableType } from "node-opcua-address-space-base";
import { type CloneOptions } from "node-opcua-address-space-base";
 ...
 * @private
 */
export declare function _clone<T extends UAObject | UAVariable | UAMethod, O>(originalNode: T, Constructor: new (options: O) => T, options: CloneOptions, optionalFilter: CloneFilter, extraInfo: CloneExtraInfo): T;
