 ...
 */
import type { AddReferenceOpts, BaseNode, IEventData, IHistoricalDataNodeOptions, ISessionContext, MethodCallInterceptor, ShutdownTask, UADataType, UAEventType, UAMethod, UAObject, UAObjectType, UAReference, UAReferenceType, UAVariable, UAVariableType, UAView } from "node-opcua-address-space-base";
...
export declare class AddressSpace implements AddressSpacePrivate {
    ...
    constructEventData(eventTypeId: UAEventType, dataInput: Record<string, unknown>): IEventData;
    /**
     * browse some path.
     *
    ...
    _coerce_DataType(dataType: number | NodeId | string | BaseNode): NodeId;
