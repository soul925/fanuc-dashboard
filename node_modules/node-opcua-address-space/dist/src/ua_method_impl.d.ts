 ...
 */
import { type CloneExtraInfo, type CloneFilter, type CloneOptions, type ISessionContext, type MethodFunctor, type UAMethod, type UAMethodEvents, type UAObject, type UAObjectType } from "node-opcua-address-space-base";
...
export declare class UAMethodImpl extends BaseNodeImpl<UAMethodEvents> implements UAMethod {
