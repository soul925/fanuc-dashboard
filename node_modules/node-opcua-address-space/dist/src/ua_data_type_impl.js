    ...
    readAttribute(context, attributeId, indexRange, dataEncoding) {
        ...
        switch (attributeId) {
            case node_opcua_data_model_1.AttributeIds.IsAbstract:
                ...
                break;
            case node_opcua_data_model_1.AttributeIds.DataTypeDefinition:
                {
...
function makeStructureDefinition(baseDataType, defaultEncodingId, fields, isUnion) {
    ...
    const structureType = isUnion
        ? hasSubtypedFields
            ? node_opcua_types_1.StructureType.UnionWithSubtypedValues
            : node_opcua_types_1.StructureType.Union
        : hasOptionalFields
            ? node_opcua_types_1.StructureType.StructureWithOptionalFields
            : hasSubtypedFields
                ? node_opcua_types_1.StructureType.StructureWithSubtypedValues
    ...
    const isUnionOrStructureWithSubtypedValues = structureType === node_opcua_types_1.StructureType.UnionWithSubtypedValues || structureType === node_opcua_types_1.StructureType.StructureWithSubtypedValues;
    ...
    // not Null NodeId (i=0)
    const baseDataTypeNodeId = (0, node_opcua_nodeid_1.resolveNodeId)(node_opcua_constants_1.DataTypeIds.BaseDataType);
