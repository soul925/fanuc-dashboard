import type { BindExtensionObjectOptions, UAVariable } from "node-opcua-address-space-base";
...
export declare function _installExtensionObjectBindingOnProperties(uaVariable: UAVariableImpl, _options?: BindExtensionObjectOptions): void;
