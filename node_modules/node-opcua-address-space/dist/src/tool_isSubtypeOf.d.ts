 ...
 */
import type { BaseNode, UADataType, UAObjectType, UAReferenceType, UAVariableType } from "node-opcua-address-space-base";
...
export declare function wipeMemorizedStuff(node: object): void;
...
export declare function get_subtypeOfObj<T extends BaseNode>(this: T): T | null;
