...
exports.UATwoStateDiscreteImpl = exports.UATwoStateDiscreteImplBase = void 0;
...
class UATwoStateDiscreteImplBase extends ua_variable_impl_1.UAVariableImpl {
    get $5() {
        return this;
    }
    /*
    ...
    getTrueStateAsString() {
        return this.$5.trueState.readValue().value.value.text || "";
    }
    getFalseStateAsString() {
        return this.$5.falseState.readValue().value.value.text || "";
    }
...
exports.UATwoStateDiscreteImplBase = UATwoStateDiscreteImplBase;
exports.UATwoStateDiscreteImpl = UATwoStateDiscreteImplBase;
function promoteToTwoStateDiscrete(node) {
    if (node instanceof exports.UATwoStateDiscreteImpl) {
        return node; // already promoted
    }
    Object.setPrototypeOf(node, exports.UATwoStateDiscreteImpl.prototype);
    (0, node_opcua_assert_1.default)(node instanceof exports.UATwoStateDiscreteImpl, "should now  be a UATwoStateDiscrete");
    const _node = node;
...
function _addTwoStateDiscrete(namespace, options) {
    ...
    (0, node_opcua_assert_1.default)(!Object.hasOwn(options, "ValuePrecision"));
