...
exports.validateDataType = exports.UAMultiStateValueDiscreteImpl = exports.UAMultiStateValueDiscreteImplBase = void 0;
...
function install_synchronization(_variable) {
    _variable.on("value_changed", (dataValue) => {
        const valueAsTextNode = _variable.valueAsText || _variable.getComponentByName("ValueAsText");
        if (!valueAsTextNode) {
            return;
        }
...
class UAMultiStateValueDiscreteImplBase extends ua_variable_impl_1.UAVariableImpl {
    get $6() {
        return this;
    }
...
exports.UAMultiStateValueDiscreteImplBase = UAMultiStateValueDiscreteImplBase;
exports.UAMultiStateValueDiscreteImpl = UAMultiStateValueDiscreteImplBase;
function promoteToMultiStateValueDiscrete(node) {
    if (node instanceof exports.UAMultiStateValueDiscreteImpl) {
        return node; // already promoted
    }
    Object.setPrototypeOf(node, exports.UAMultiStateValueDiscreteImpl.prototype);
    (0, node_opcua_assert_1.assert)(node instanceof exports.UAMultiStateValueDiscreteImpl, "should now  be a State Machine");
...
function _addMultiStateValueDiscrete(namespace, options) {
    (0, node_opcua_assert_1.assert)(Object.hasOwn(options, "enumValues"));
    (0, node_opcua_assert_1.assert)(!Object.hasOwn(options, "ValuePrecision"));
