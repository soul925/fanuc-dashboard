...
exports.UAStateMachineTypeImpl = exports.UAStateMachineImpl = exports.UAStateMachineImplBase = exports.UATransitionImpl = exports.UATransitionImplBase = void 0;
...
class UATransitionImplBase extends base_node_impl_1.BaseNodeImpl {
}
exports.UATransitionImplBase = UATransitionImplBase;
exports.UATransitionImpl = UATransitionImplBase;
...
const $ = (uaObject) => uaObject;
/*
 *
 * @class StateMachine
 *
 */
class UAStateMachineImplBase extends ua_object_impl_1.UAObjectImpl {
    getStates() {
    ...
    setState(toStateNode, predicate) {
        ...
        const applyTransitionOptionalPropsPhase1 = () => {
            ...
            if (!stateMachineType)
                throw new Error("cannot find StateMachineType");
        ...
        for (const method of this.getMethods()) {
            method._notifyAttributeChange(node_opcua_data_model_1.AttributeIds.Executable);
        }
    }
    /**
     * @internal
...
exports.UAStateMachineImplBase = UAStateMachineImplBase;
exports.UAStateMachineImpl = UAStateMachineImplBase;
function promoteToStateMachine(node) {
    if (node instanceof exports.UAStateMachineImpl) {
        return node; // already promoted
    }
    Object.setPrototypeOf(node, exports.UAStateMachineImpl.prototype);
    (0, node_opcua_assert_1.assert)(node instanceof exports.UAStateMachineImpl, "should now  be a State Machine");
    const _node = node;
