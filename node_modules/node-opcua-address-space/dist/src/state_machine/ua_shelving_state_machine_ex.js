...
exports.UAShelvedStateMachineExImpl = exports.UAShelvedStateMachineExImplBase = void 0;
...
class UAShelvedStateMachineExImplBase extends finite_state_machine_1.UAStateMachineImpl {
    static promote(object) {
        const shelvingState = object;
        (0, finite_state_machine_1.promoteToStateMachine)(shelvingState);
        Object.setPrototypeOf(shelvingState, exports.UAShelvedStateMachineExImpl.prototype);
        ...
        (0, node_opcua_assert_1.assert)(shelvingState instanceof exports.UAShelvedStateMachineExImpl);
        return shelvingState;
    }
}
exports.UAShelvedStateMachineExImplBase = UAShelvedStateMachineExImplBase;
exports.UAShelvedStateMachineExImpl = UAShelvedStateMachineExImplBase;
...
function _start_timer_for_automatic_unshelve(shelvingState, duration) {
    ...
    if (duration !== ua_alarm_condition_impl_1.UAAlarmConditionImplBase.MaxDuration) {
        (0, node_opcua_assert_1.assert)(!shelvingState._timer);
...
function _timedShelve_method(inputArguments, context, callback) {
    ...
    (0, node_opcua_assert_1.assert)(Number.isFinite(maxTimeShelved));
...
function _oneShotShelve_method(inputArguments, context, callback) {
    ...
    const maxTimeShelved = alarmNode.getMaxTimeShelved();
    (0, node_opcua_assert_1.assert)(Number.isFinite(maxTimeShelved));
    (0, node_opcua_assert_1.assert)(maxTimeShelved !== ua_alarm_condition_impl_1.UAAlarmConditionImplBase.MaxDuration);
...
function _unShelveTimeFunc(shelvingState) {
    ...
    if (shelvingState.getCurrentState() === "OneShotShelved" && shelvingState._duration === ua_alarm_condition_impl_1.UAAlarmConditionImplBase.MaxDuration) {
        return new node_opcua_data_value_1.DataValue({
            statusCode: node_opcua_status_code_1.StatusCodes.Good,
            value: {
                dataType: node_opcua_variant_1.DataType.Double,
                value: ua_alarm_condition_impl_1.UAAlarmConditionImplBase.MaxDuration
            }
        });
    }
    const now = new Date();
