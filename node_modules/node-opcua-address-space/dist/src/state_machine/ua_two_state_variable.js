...
function _updateTransitionTime(node, _subState, options) {
    ...
    if (node.transitionTime) {
        ...
        node.transitionTime.setValueFromSource({ dataType: node_opcua_variant_1.DataType.DateTime, value: transitionTime });
    }
}
...
function _getEffectiveDisplayName(node) {
    ...
    const _states = subStateNodes.forEach((_n) => {
        // todo happen
    });
    return humanReadableString;
}
function _getHumanReadableString(node) {
    ...
    (0, node_opcua_assert_1.assert)(dataValue.value.dataType === node_opcua_variant_1.DataType.Boolean);
...
function _install_TwoStateVariable_machinery(node, options) {
    ...
    (0, node_opcua_assert_1.assert)(node.dataTypeObj.browseName.toString() === "LocalizedText");
    (0, node_opcua_assert_1.assert)(Object.hasOwn(node, "valueRank") && (node.valueRank === -1 || node.valueRank === 0));
...
class UATwoStateVariableImpl extends ua_variable_impl_1.UAVariableImplT {
    ...
    initialize(options) {
        ...
        if (options.value === undefined) {
            ...
            (0, node_opcua_assert_1.assert)(options.value.dataType === node_opcua_variant_1.DataType.Boolean);
    ...
    setValue(boolValue, options) {
        ...
        //
        this.id.setValueFromSource(new node_opcua_variant_1.Variant({ dataType: node_opcua_variant_1.DataType.Boolean, value: boolValue }));
    ...
    getValueAsString() {
        ...
        (0, node_opcua_assert_1.assert)(dataValue.statusCode.isGood());
        (0, node_opcua_assert_1.assert)(dataValue.value.dataType === node_opcua_variant_1.DataType.LocalizedText);
    ...
    _add_backward_reference(reference) {
        ...
        if (reference.isForward &&
            ((0, node_opcua_nodeid_1.sameNodeId)(reference.referenceType, hasTrueSubState_ReferenceTypeNodeId) ||
                (0, node_opcua_nodeid_1.sameNodeId)(reference.referenceType, hasFalseSubState_ReferenceTypeNodeId))) {
...
function _addTwoStateVariable(namespace, options) {
    ...
    const node = twoStateVariableType.instantiate({
        ...
        dataType: (0, node_opcua_nodeid_1.resolveNodeId)(node_opcua_variant_1.DataType.LocalizedText),
