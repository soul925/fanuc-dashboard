...
export interface UAConditionEx<T extends UAConditionEvents & ListenerSignature<T> = UAConditionEvents> extends UABaseEventEx, UACondition_Base, UAObject<T>, UAConditionHelper {
