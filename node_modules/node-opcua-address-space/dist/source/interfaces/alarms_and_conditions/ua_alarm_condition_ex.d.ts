...
export interface UAAlarmConditionEx<T extends UALarmConditionEvents & ListenerSignature<T> = UALarmConditionEvents> extends UAAlarmConditionHelper, UAAlarmCondition_Base, UAAcknowledgeableConditionEx<T> {
