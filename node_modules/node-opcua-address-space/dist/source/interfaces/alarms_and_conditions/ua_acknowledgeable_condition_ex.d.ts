...
export interface UAAcknowledgeableConditionEx<T extends UAAcknowledgeableConditionEvents & ListenerSignature<T> = UAAcknowledgeableConditionEvents> extends UAAcknowledgeableCondition_Base, UAAcknowledgeableConditionHelper, UAConditionEx<T> {
