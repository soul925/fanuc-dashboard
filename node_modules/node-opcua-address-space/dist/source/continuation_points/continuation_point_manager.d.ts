 ...
 */
import type { ContinuationData, ContinuationPoint, IContinuationPointInfo, IContinuationPointManager } from "node-opcua-address-space-base";
...
export declare class ContinuationPointManager implements IContinuationPointManager {
    ...
    clearContinuationPoint(continuationPoint: ContinuationPoint): void;
    clearContinuationPoints(continuationPoints: ContinuationPoint[]): {
