...
function encode_ArgumentList(definition, args, stream) {
    ...
    for (let i = 0; i < definition.length; i++) {
        ...
        if (!encodeFunc) {
            throw new Error("This BaseDataType cannot be encoded because it has no definition.\n" +
...
function checkValueRank(argDefinition, arg) {
    const isArray = arg.arrayType === node_opcua_variant_1.VariantArrayType.Array;
    const isMatrix = arg.arrayType === node_opcua_variant_1.VariantArrayType.Matrix;
...
function isArgumentValid(addressSpace, argDefinition, arg) {
    (0, node_opcua_assert_1.assert)(Object.hasOwn(argDefinition, "dataType"));
    (0, node_opcua_assert_1.assert)(Object.hasOwn(argDefinition, "valueRank"));
