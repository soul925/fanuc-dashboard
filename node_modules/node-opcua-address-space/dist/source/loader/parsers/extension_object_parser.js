...
const EUInformation_parser = {
    EUInformation: {
        init(_name, _attrs, _parent, _engine) {
                    ...
                    finish() {
                        ...
                        switch (typeDefinitionId.toString()) {
                            ...
                            case "ns=0;i=7616": {
                                ...
                                (0, node_assert_1.default)(extensionObject !== null && typeof extensionObject === "object");
                                (0, node_assert_1.default)(extensionObject instanceof node_opcua_extension_object_1.ExtensionObject);
