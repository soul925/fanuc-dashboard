...
function BasicType_parser(dataType, parseFunc) {
    const _parser = {};
    const a = {
        init(_name, _attrs, _parent, _endElement) {
...
function _installExtensionObjectListInitializationPostTask(postTasks2_AssignedExtensionObjectToDataValue, element) {
...
function makeVariantReader(setValue, setDeferredValue, postExtensionObjectDecoding, translateNodeId) {
    ...
    const reader = {
        ...
        parser: {
            ...
            }, (xmlEncodingNodeId, bodyXML, _data) => {
