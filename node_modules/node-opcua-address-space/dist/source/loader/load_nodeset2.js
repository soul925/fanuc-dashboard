 ...
 */
function isUninitializedMatrix(value) {
    ...
    const state_UAVariable = {
        init(_name, attrs) {
            ...
            this.obj = {
                ...
                historizing: (0, node_opcua_basic_types_1.coerceBoolean)(attrs.Historizing),
                nodeId,
            ...
            if (this.obj.value && this.obj.value.dataType !== node_opcua_variant_1.DataType.Null) {
                ...
                const task = async (_addressSpace2) => {
                    ...
                    if (value) {
                        ...
                        if (value.dataType === node_opcua_variant_1.DataType.Null || isUninitializedMatrix(value)) {
