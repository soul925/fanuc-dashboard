...
import type { AccessRestrictionsFlag, AttributeIds, BrowseDirection, LocalizedText, LocalizedTextLike, NodeClass, QualifiedName, QualifiedNameLike, QualifiedNameOptions } from "node-opcua-data-model";
import type { DataValue } from "node-opcua-data-value";
import type { NodeId, NodeIdLike } from "node-opcua-nodeid";
import type { NumericRange } from "node-opcua-numeric-range";
import type { StatusCode } from "node-opcua-status-code";
import type { BrowseDescriptionOptions, ReferenceDescription, RelativePathElement, RolePermissionType, RolePermissionTypeOptions, WriteValueOptions } from "node-opcua-types";
...
export type AttributeEventName = "Value_changed" | "DisplayName_changed" | "Description_changed" | "BrowseName_changed" | "RolePermissions_changed" | "AccessRestrictions_changed";
...
export declare const TypedEventEmitter: {
