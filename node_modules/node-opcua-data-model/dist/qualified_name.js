...
function stringToQualifiedName(value) {
    ...
    if (!Number.isNaN(parseFloat(splitArray[0])) &&
...
function coerceQualifiedName(value) {
    if (!value) {
        ...
        (0, node_opcua_assert_1.assert)(Object.hasOwn(value, "namespaceIndex"));
        (0, node_opcua_assert_1.assert)(Object.hasOwn(value, "name"));
