...
const warningLog = (0, node_opcua_debug_1.make_warningLog)("SecurityPolicy");
const errorLog = (0, node_opcua_debug_1.make_errorLog)("SecurityPolicy");
/**
 *
...
function RSA_PSS_SHA2_256_Sign(buffer, privateKey) {
    const key = privateKey.hidden instanceof node_crypto_1.KeyObject
        ? privateKey.hidden
...
function RSA_OAEP_SHA2_256_Encrypt(buffer, publicKey) {
    ...
    for (let i = 0; i < nbBlocks; i++) {
        ...
        const encrypted_chunk = (0, node_crypto_1.publicEncrypt)(options, currentBlock);
        // c8 ignore next
...
function RSA_OAEP_SHA2_256_Decrypt(buffer, privateKey) {
    ...
    for (let i = 0; i < nbBlocks; i++) {
        ...
        const decrypted_buf = (0, node_crypto_1.privateDecrypt)(options, currentBlock);
