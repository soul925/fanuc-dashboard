...
class ClientSecureChannelLayer extends node_events_1.EventEmitter {
    ...
    constructor(options) {
        ...
        this.#transportFactory = options.transportFactory || node_opcua_transport_1.defaultClientTransportFactory;
    ...
    #_build_client_nonce() {
        ...
        return (0, node_opcua_utils_1.randomBytes)(cryptoFactory.symmetricKeyLength);
    }
