...
exports.coerceNodeId = exports.coerceExpandedNodeId = void 0;
...
function nodeID_encodingByte(nodeId) {
    ...
    if (Object.hasOwn(nodeId, "namespaceUri") && nodeId.namespaceUri) {
        encodingByte = encodingByte | EnumNodeIdEncoding.NamespaceUriFlag;
    }
    if (Object.hasOwn(nodeId, "serverIndex") && nodeId.serverIndex) {
...
function _encodeNodeId(encodingByte, nodeId, stream) {
    ...
    switch (encodingByte) {
        ...
        case EnumNodeIdEncoding.ByteString:
            ...
            break;
        default:
            (0, node_opcua_assert_1.assert)(encodingByte === EnumNodeIdEncoding.Guid);
            stream.writeUInt16(nodeId.namespace);
