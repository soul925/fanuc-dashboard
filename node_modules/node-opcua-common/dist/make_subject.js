...
exports.defaultCertificateSubject = void 0;
exports.setDefaultCertificateSubject = setDefaultCertificateSubject;
 ...
 */
exports.defaultCertificateSubject = "/O=Sterfive/L=Orleans/C=FR";
/**
 ...
 * ```
 */
function setDefaultCertificateSubject(value) {
    ...
    if (trimmed.length === 0) {
        throw new Error('setDefaultCertificateSubject: value must not be empty. ' +
...
function makeSubject(applicationName, hostname) {
    ...
    return `/CN=${commonName}` + `/DC=${dc}` + exports.defaultCertificateSubject;
}
