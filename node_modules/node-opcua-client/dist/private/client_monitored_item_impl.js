 ...
 */
class ClientMonitoredItemImpl extends node_events_1.EventEmitter {
    itemToMonitor;
    ...
    toJSON() {
        return {
            ...
            timestampsToReturn: node_opcua_service_read_1.TimestampsToReturn[this.timestampsToReturn],
    ...
    toString() {
        ...
        ret += `timestampsToReturn:   ${node_opcua_service_read_1.TimestampsToReturn[this.timestampsToReturn]}\n`;
    ...
    modify(...args) {
        ...
        if (args.length === 2) {
            this.modify(args[0], null, args[1]);
            return undefined;
        }
...
client_monitored_item_1.ClientMonitoredItem.create = (subscription, itemToMonitor, monitoringParameters, timestampsToReturn = node_opcua_service_read_1.TimestampsToReturn.Neither, monitoringMode = node_opcua_service_subscription_1.MonitoringMode.Reporting) => {
