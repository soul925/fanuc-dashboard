...
import { type Callback, type CallbackT, type StatusCode } from "node-opcua-status-code";
...
import { type EndpointWithUserIdentity, OPCUAClient, type OPCUAClientOptions, type WithSessionFuncP, type WithSubscriptionFuncP } from "../opcua_client";
import type { UserIdentityInfo } from "../user_identity_info";
import { ClientBaseImpl } from "./client_base_impl";
import { ClientSessionImpl } from "./client_session_impl";
export declare class OPCUAClientImpl extends ClientBaseImpl<OPCUAClientBaseEvents> {
    #private;
